...
public class FlightManager {
	...
	public FlightManager() {
		...
		Time checkinStart = new Time();
		checkinStart.set(0, 15, 17, 5, 5, 2014);
		Time checkinEnd = new Time();
		checkinEnd.set(0, 0, 18, 5, 5, 2014);
	...
	public Passenger getPassengerByReservation(String reservationNumber)
			throws Exception {
		for (Flight flight : fligths) {
			for (Passenger passenger : flight.getPassengers()) {
